...
import 'package:mcq_app/models/mcq_paper.dart';
import 'package:mcq_app/providers/mcq_paper_provider.dart';
...
class PaperEditPage extends StatefulWidget {
  static const routeName = '/paper-edit-page';

  @override
  _PaperEditStatePage createState() => _PaperEditStatePage();
}

class _PaperEditStatePage extends State<PaperEditPage> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      final paperId = ModalRoute.of(context).settings.arguments as String;
      if (paperId != null) {
        _editedPaper = Provider.of<MCQPaperProvider>(
          context,
          listen: false,
        ).findById(paperId);
        _initValues = {
          'title': _editedPaper.paperName,
          'description': _editedPaper.paperDescription,
          'price': _editedPaper.paperAvgRating.toString(),
          //'imageUrl': _editedVehicle.imageUrl,
          'imageUrl': '',
        };
        _imageUrlController.text = _editedPaper.paperThumbnailImgURL;
      }
    }
    _isInit = false;
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      onSaved: (value) {
                        _editedPaper = MCQPaper(
                          paperId: null,
                          paperHostId: null,
                          subjectId: null,
                          paperName: null,
                          paperThumbnailImgURL: null,
                          paperGrade: null,
